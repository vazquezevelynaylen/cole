    ...
    <section className="especialidades" id="especialidades">
      ...
      <div className="es-intro">
        <div className="es-intro-image">
          <img src="/img/multi1.jpg" alt="Escuela Técnica N.º 20" />
        </div>
        <div className="es-intro-content">
          <span className="es-label">ESCUELA TÉCNICA N.º 20</span>
          <h2>
            Mucho más<br />que una <span>escuela.</span>
          </h2>
          <p>
            Una comunidad que aprende, crea y construye oportunidades. Con más de 60 años
            de trayectoria, impulsamos una educación técnica actual, innovadora y humana.
          </p>
      ...
      <div className="es-specialties">
        <article className="es-specialty es-tic">
          ...
          <a href="/tic" className="es-specialty-link"><span>→</span></a>
        </article>

        <article className="es-specialty es-electronica">
          <div className="es-specialty-icon">⚡</div>
          <h3>Electrónica</h3>
          <p>Diseño y mantenimiento de sistemas electrónicos.</p>
          <a href="/electronica" className="es-specialty-link"><span>→</span></a>
        </article>
        ...
        <article className="es-specialty es-multimedia">
          ...
          <a href="/multimedia" className="es-specialty-link"><span>→</span></a>
        </article>
      </div>
      ...
      <div className="es-projects">
        <div className="es-project">
          <img src="/img/proyecto1.jpg" alt="Proyecto de la escuela" />
        </div>
        <div className="es-project">
          <img src="/img/proyecto2.jpg" alt="Proyecto de programación" />
        </div>
        <div className="es-project">
          <img src="/img/proyecto3.jpg" alt="Proyecto multimedia" />
        </div>
        <div className="es-project">
          <img src="/img/proyecto4.jpg" alt="Proyecto tecnológico" />
        </div>
      </div>
